# Q4: Highlights/Lowlights - Examples

**Part of**: MBR Generation Specification v3.0
**See also**: [Q4 Format Rules](../rules/mbr_format_q4.md)
...
✅ **Process improvement**: All $1M+ renewals through PDM
✅ **[Next Steps]**: Monthly checkpoints, SKO presentation in May

## BAD Example: Highlight (avoid this)

"[H] Big Customer Win. We closed a large deal. Customer is happy. Good work by the team."

### Why BAD (Highlight)

❌ **No account name** (which customer?)
❌ **No $ amount** (how large?)
❌ **No story** (what happened?)
❌ **Generic**: "big", "large", "good" are meaningless
❌ **No competitive context** (what did we overcome?)
❌ **No people named** (which SA? which customer contacts?)
❌ **No next steps** (what happens now?)
❌ **One sentence** (needs 3-5 sentences)

## BAD Example: Lowlight (avoid this)

"[L] Deal Delayed. Customer had procurement issues. We're working on it."

### Why BAD (Lowlight)

❌ **No account name** (which customer?)
❌ **No $ amount** (what was at risk?)
❌ **No root cause** (why procurement issues?)
❌ **No lessons learned** (what do we do differently?)
❌ **Vague**: "working on it" is not actionable
❌ **No people named** (who's working on it?)
❌ **No next steps** with owner/date
❌ **Too short** (needs 3-5 sentences)

## What Makes Q4 Examples Work

### Highlights Must Tell
- **What happened**: The win, the achievement
- **Why it matters**: Business impact, $ amount, YoY growth
- **How we did it**: SA engagement, technical work, dates
- **Competitive angle**: What we overcame (GCP, Azure, first-party)
- **What's next**: Future plans with owner and date

### Lowlights Must Tell
- **What happened**: The problem, delay, or setback
- **Why it happened**: Root cause, what went wrong
- **How we responded**: Escalation, recovery actions
- **What we learned**: Process improvements, training needs
- **What's next**: Corrective actions with owner and date

### Common Mistakes to Avoid
- Using bullet points (Q4 must be prose)
- Using STAR format (Situation:/Task:/Action:/Result:)
- One-sentence summaries (need 3-5 sentences)
- Omitting competitive context
- Vague next steps
